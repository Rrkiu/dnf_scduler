...
export default async function ScheduleDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen">
      <div className="mb-4 md:mb-6 flex justify-between items-center border-b pb-3 md:pb-4">
        <div>
          <Link href="/schedules" className="text-sm font-medium text-blue-500 hover:text-blue-700 mb-1 md:mb-2 inline-block">&larr; Back to Schedules</Link>
          <h1 className="text-xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">{schedule.name}</h1>
        </div>
      </div>
